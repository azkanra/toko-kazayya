            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tlp" name="tlp" placeholder="Masukan Nomor Penerima" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="tlp" class="col-form-label col-sm-3">No. Hp Penerima</label>
            ...
            <div class="card">
                ...
                <div class="card-body pembayaran">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            @if (Auth::user())
                            <input type="number" class="form-control discount" id="discount" name="discount" value="0.1">
                            @else
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control ongkir" id="ongkir" name="ongkir" value="0">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="dibayarkan" name="dibayarkan" value="0" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="dibayarkan" class="col-form-label col-sm-6">Jumlah SKU </label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="dibayarkan" name="jumlahBarang" value="{{$jumlahBarang}}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="dibayarkan" class="col-form-label col-sm-6">Total Quantity </label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" id="dibayarkan" name="totalQty" value="{{$qtyOrder}}" readonly>
                        </div>
                    </div>
