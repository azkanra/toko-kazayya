...
<div class="card mb-3">
    <div class="card-body d-flex gap-4">
        <img src="{{ asset('assets/images/baju.png') }}" style="width: 200px; height: 200px;" alt="">
        <div class="desc w-100">
            <p style="font-size: 24px; font-weight:700;">Niara Dress</p>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-5 d-flex">
                    ...
                    <input type="number" name="qty" class=" form-control text-center w-25" id="qty" min="0" max="9999" value="1">
