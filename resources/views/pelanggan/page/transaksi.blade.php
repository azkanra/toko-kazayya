...
<div class="card mb-3">
    <div class="card-body d-flex gap-4">
        <img src="{{ asset('storage/product/' . $x->product->foto) }}" style="width: 200px; height: 200px;" alt="">
        <form action="{{route('checkout.product', ['id' => $x->id])}}" method="POST">
            ...
            <div class="desc w-100">
                ...
                <input type="number" class="form-control border-0 fs-1" name="harga" id="harga" value="{{$x->product->harga}}">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-5 d-flex">
                        ...
                        <input type="number" name="qty" class=" form-control text-center w-25" id="qty" name="qty" value="{{$x->qty}}">
                ...
                <div class="row">
                    ...
                    <input type="text" class="col-sm-2 form-control w-25 border-0 fs-4 total" name="total" readonly id="total">
                </div>
